<?php
	...
	//------------------------------------------------
	define("KEY", md5('key'));
	define("KEYDEL", md5('keydel'));
	define("KEYPASS", md5('keypass'));
	define("KEYSHOW", md5('keyshow'));
	//------------------------------------------------
	//  Variables de  mensajes
	//------------------------------------------------
	define("GOOD", md5('good'));
	define("GOODMSG", md5('goodmsg'));
	define("ERROR", md5('error'));
	
	//------------------------------------------------
	//  Idiomas
	//------------------------------------------------
	
	static $eng = array('January','February','March','April','May','June','July','August','September','October','November','December');
	static $esp = array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
	...
	//  MODULE
	//------------------------------------------------
	define("MODULE_ZZVM", 4);
	define("MODULE_RMOBILE", 1);
	//------------------------------------------------
	//  WEB USER ZUZUVAMA
	//------------------------------------------------
	define("ID_ZZVM", 1);
	...
	//  Site Root
	//------------------------------------------------
	define("SITE_ROOT", $_SERVER['DOCUMENT_ROOT']."zuzuvama/include/");
