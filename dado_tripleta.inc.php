...
<div id="area2" class="area">
    <div id="cube2" class="cube">
        ...
        <div id="dice1_2" class="side front" ></div>
        <div id="dice6_2" class="side back" ></div>
        <div id="dice2_2" class="side bottom" ></div>
        <div id="dice4_2" class="side top" ></div>
        <div id="dice3_2" class="side right" ></div>
        <div id="dice5_2" class="side left" ></div>
...
<div id="area3" class="area">
    <div id="cube3" class="cube">
        ...
        <div id="dice1_3" class="side front" ></div>
        <div id="dice6_3" class="side back" ></div>
        <div id="dice2_3" class="side bottom" ></div>
        <div id="dice4_3" class="side top" ></div>
        <div id="dice3_3" class="side right" ></div>
        <div id="dice5_3" class="side left" ></div>
     ...
     <td align="center">
        <fieldset data-role="controlgroup" >
            <input type="checkbox" name="checkbox-1a" id="checkbox-1a" class="custom" onChange="onChange(this);">
            	<label id="dice1" for="checkbox-1a"><img src="images/dice_1.svg" width="32" style="background:rgba(255,255,255,1)"/></label>
